...
import com.example.cenidet.models.Comment;
...
public class CommentAdapter extends FirestoreRecyclerAdapter<Comment, CommentAdapter.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, int position, @NonNull final Comment comment) {
                        ...
                        if(documentSnapshot.contains("image_profile")){
                            ...
                            if(imageProfile != null){
                                if(!imageProfile.isEmpty()){
                                    Picasso.with(context).load(imageProfile).into(holder.circleImageCommet);
                                }
                            }
                        }
                    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        CircleImageView circleImageCommet;
        View viewHolder;
        ...
        public ViewHolder(View view){
            ...
            circleImageCommet = view.findViewById(R.id.circleImageComment);
            viewHolder = view;
        }
    }
}
