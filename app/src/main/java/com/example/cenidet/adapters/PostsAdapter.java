...
import com.example.cenidet.activities.PostDetailActivity;
import com.example.cenidet.models.Like;
...
public class PostsAdapter extends FirestoreRecyclerAdapter<Post, PostsAdapter.ViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull final ViewHolder holder, int position, @NonNull final Post post) {
       ...
       // String userId = document.getString("idUser"); este es una forma de obtener el ID y toda la informacion del usuario
        ...
        chekIfExistlike(postId, mAuthProvider.getUid(), holder);
        ...
        mLikesProvider.getLikeByPostAndUser(like.getIdPost(), mAuthProvider.getUid()).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                if (numberDocuments>0){
                    ...
                    holder.imageViewLike.setImageResource(R.drawable.me_gustagris);
                    mLikesProvider.delete(idLike);
                }else{
                    holder.imageViewLike.setImageResource(R.drawable.me_gusta);
    ...
    private void chekIfExistlike(String idPost, String idUser, final ViewHolder holder) {
